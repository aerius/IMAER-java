...
import nl.overheid.aerius.gml.v3_1.source.farmland.FarmlandActivity;
import nl.overheid.aerius.gml.v3_1.source.farmland.FarmlandActivityProperty;
...
class Farmland2GML extends SpecificSource2GML<FarmlandEmissionSource> {
  ...
  @Override
  public nl.overheid.aerius.gml.v3_1.source.EmissionSource convert(final FarmlandEmissionSource emissionSource) {
    final nl.overheid.aerius.gml.v3_1.source.farmland.FarmlandEmissionSource returnSource = new nl.overheid.aerius.gml.v3_1.source.farmland.FarmlandEmissionSource();
