...
import nl.overheid.aerius.gml.v3_1.source.lodging.AdditionalLodgingSystem;
import nl.overheid.aerius.gml.v3_1.source.lodging.CustomFarmLodging;
import nl.overheid.aerius.gml.v3_1.source.lodging.FarmLodging;
import nl.overheid.aerius.gml.v3_1.source.lodging.FarmLodgingEmissionSource;
import nl.overheid.aerius.gml.v3_1.source.lodging.FarmLodgingProperty;
import nl.overheid.aerius.gml.v3_1.source.lodging.LodgingFodderMeasure;
import nl.overheid.aerius.gml.v3_1.source.lodging.LodgingFodderMeasureProperty;
import nl.overheid.aerius.gml.v3_1.source.lodging.LodgingSystemProperty;
import nl.overheid.aerius.gml.v3_1.source.lodging.ReductiveLodgingSystem;
...
class Farm2GML extends SpecificSource2GML<nl.overheid.aerius.shared.domain.v2.source.FarmLodgingEmissionSource> {
  ...
  private FarmLodgingProperty convert(final nl.overheid.aerius.shared.domain.v2.source.farm.CustomFarmLodging lodging) {
    ...
    //custom farm does NOT have a code.
    return new FarmLodgingProperty(gmlLodging);
  }
