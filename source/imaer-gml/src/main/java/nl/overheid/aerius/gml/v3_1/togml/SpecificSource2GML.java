...
abstract class SpecificSource2GML<T extends EmissionSource> {
  ...
  abstract nl.overheid.aerius.gml.v3_1.source.EmissionSource convert(T emissionSource) throws AeriusException;

  protected List<EmissionProperty> getEmissions(final Map<Substance, Double> emissionValues, final Substance defaultSubstance) {
