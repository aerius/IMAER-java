...
import nl.overheid.aerius.gml.v5_1.source.characteristics.AbstractHeatContent;
import nl.overheid.aerius.gml.v5_1.source.characteristics.CalculatedHeatContent;
import nl.overheid.aerius.gml.v5_1.source.characteristics.EmissionSourceCharacteristics;
import nl.overheid.aerius.gml.v5_1.source.characteristics.SpecifiedHeatContent;
...
final class SourceCharacteristics2GML {
  ...
  static nl.overheid.aerius.gml.v5_1.source.characteristics.ADMSSourceCharacteristics toGML(
      final ADMSSourceCharacteristics characteristics) throws AeriusException {
    final nl.overheid.aerius.gml.v5_1.source.characteristics.ADMSSourceCharacteristics returnCharacteristics =
        new nl.overheid.aerius.gml.v5_1.source.characteristics.ADMSSourceCharacteristics();
    returnCharacteristics.setBuilding(determineBuilding(characteristics));
  ...
  private static void determineEffluxType(final ADMSSourceCharacteristics characteristics,
      final nl.overheid.aerius.gml.v5_1.source.characteristics.ADMSSourceCharacteristics returnCharacteristics) throws AeriusException {
