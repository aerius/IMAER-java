...
import nl.overheid.aerius.gml.v5_1.source.ship.CustomInlandShippingEmissionPropertiesProperty;
import nl.overheid.aerius.gml.v5_1.source.ship.InlandWaterway;
import nl.overheid.aerius.gml.v5_1.source.ship.InlandWaterwayProperty;
...
final class Inland2GMLUtil {
  ...
  static CustomInlandShippingEmissionPropertiesProperty toCustomEmissionProperties(final CustomInlandShippingEmissionProperties originalProperties) {
    final nl.overheid.aerius.gml.v5_1.source.ship.CustomInlandShippingEmissionProperties properties = new nl.overheid.aerius.gml.v5_1.source.ship.CustomInlandShippingEmissionProperties();
