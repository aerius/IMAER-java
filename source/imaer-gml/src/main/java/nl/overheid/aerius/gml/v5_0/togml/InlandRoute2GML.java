...
import nl.overheid.aerius.gml.v5_0.source.ship.InlandShippingProperty;
...
class InlandRoute2GML extends SpecificSource2GML<InlandShippingEmissionSource> {
  ...
  public nl.overheid.aerius.gml.v5_0.source.EmissionSource convert(final InlandShippingEmissionSource emissionSource) throws AeriusException {
    ...
    for (final InlandShipping vesselGroupEmissionValues : vesselGroups) {
      final nl.overheid.aerius.gml.v5_0.source.ship.InlandShipping gmlShip = determineType(vesselGroupEmissionValues);
  ...
  private nl.overheid.aerius.gml.v5_0.source.ship.InlandShipping determineType(final InlandShipping inlandShipping) {
    nl.overheid.aerius.gml.v5_0.source.ship.InlandShipping gmlInlandShipping;
  ...
  private nl.overheid.aerius.gml.v5_0.source.ship.InlandShipping toCustom(final CustomInlandShipping inlandShipping) {
    final nl.overheid.aerius.gml.v5_0.source.ship.CustomInlandShipping gmlShip = new nl.overheid.aerius.gml.v5_0.source.ship.CustomInlandShipping();
