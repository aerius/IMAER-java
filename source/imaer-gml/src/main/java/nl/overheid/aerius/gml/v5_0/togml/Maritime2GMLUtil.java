...
import nl.overheid.aerius.gml.v5_0.source.ship.CustomMaritimeShippingEmissionPropertiesProperty;
...
final class Maritime2GMLUtil {
  ...
  static CustomMaritimeShippingEmissionPropertiesProperty toCustomEmissionProperties(
    ...
    final nl.overheid.aerius.gml.v5_0.source.ship.CustomMaritimeShippingEmissionProperties gmlProperties = new nl.overheid.aerius.gml.v5_0.source.ship.CustomMaritimeShippingEmissionProperties();
