...
import nl.overheid.aerius.gml.v5_1.source.ship.InlandShippingProperty;
...
class InlandRoute2GML extends SpecificSource2GML<InlandShippingEmissionSource> {
  ...
  @Override
  public nl.overheid.aerius.gml.v5_1.source.EmissionSource convert(final InlandShippingEmissionSource emissionSource) throws AeriusException {
    final nl.overheid.aerius.gml.v5_1.source.ship.InlandShippingEmissionSource returnSource =
        new nl.overheid.aerius.gml.v5_1.source.ship.InlandShippingEmissionSource();
    ...
    for (final InlandShipping vesselGroupEmissionValues : vesselGroups) {
      final nl.overheid.aerius.gml.v5_1.source.ship.InlandShipping gmlShip = determineType(vesselGroupEmissionValues);
  ...
  private nl.overheid.aerius.gml.v5_1.source.ship.InlandShipping determineType(final InlandShipping inlandShipping) {
    nl.overheid.aerius.gml.v5_1.source.ship.InlandShipping gmlInlandShipping;
  ...
  private nl.overheid.aerius.gml.v5_1.source.ship.InlandShipping toStandard(final StandardInlandShipping inlandShipping) {
    final nl.overheid.aerius.gml.v5_1.source.ship.StandardInlandShipping gmlShip =
        new nl.overheid.aerius.gml.v5_1.source.ship.StandardInlandShipping();
    gmlShip.setCode(inlandShipping.getShipCode());
    return gmlShip;
  }

  private nl.overheid.aerius.gml.v5_1.source.ship.InlandShipping toCustom(final CustomInlandShipping inlandShipping) {
    final nl.overheid.aerius.gml.v5_1.source.ship.CustomInlandShipping gmlShip = new nl.overheid.aerius.gml.v5_1.source.ship.CustomInlandShipping();
