...
import nl.overheid.aerius.gml.v3_1.source.Emission;
 ...
 */
final class Source2GML implements EmissionSourceVisitor<nl.overheid.aerius.gml.v3_1.source.EmissionSource> {
  ...
  private nl.overheid.aerius.gml.v3_1.source.EmissionSource toGMLDefault(final EmissionSourceFeature sourceFeature,
    ...
    final nl.overheid.aerius.gml.v3_1.source.EmissionSource returnSource = sourceFeature.accept(this);
  ...
  @Override
  public nl.overheid.aerius.gml.v3_1.source.EmissionSource visit(final GenericEmissionSource emissionSource, final IsFeature feature) {
    return new nl.overheid.aerius.gml.v3_1.source.EmissionSource();
  }

  @Override
  public nl.overheid.aerius.gml.v3_1.source.EmissionSource visit(final MooringMaritimeShippingEmissionSource emissionSource, final IsFeature feature)
      throws AeriusException {
    return new MaritimeMooring2GML(geometry2gml).convert(emissionSource);
  }

  @Override
  public nl.overheid.aerius.gml.v3_1.source.EmissionSource visit(final MaritimeShippingEmissionSource emissionSource, final IsFeature feature)
      throws AeriusException {
    return new MaritimeRoute2GML().convert(emissionSource);
  }

  @Override
  public nl.overheid.aerius.gml.v3_1.source.EmissionSource visit(final InlandShippingEmissionSource emissionSource, final IsFeature feature)
      throws AeriusException {
    return new InlandRoute2GML().convert(emissionSource);
  }

  @Override
  public nl.overheid.aerius.gml.v3_1.source.EmissionSource visit(final MooringInlandShippingEmissionSource emissionSource, final IsFeature feature)
      throws AeriusException {
    return new InlandMooring2GML(geometry2gml).convert(emissionSource);
  }

  @Override
  public nl.overheid.aerius.gml.v3_1.source.EmissionSource visit(final OffRoadMobileEmissionSource emissionSource, final IsFeature feature)
      throws AeriusException {
    return new OffRoad2GML().convert(emissionSource);
  }

  @Override
  public nl.overheid.aerius.gml.v3_1.source.EmissionSource visit(final PlanEmissionSource emissionSource, final IsFeature feature)
      throws AeriusException {
    return new Plan2GML().convert(emissionSource);
  }

  @Override
  public nl.overheid.aerius.gml.v3_1.source.EmissionSource visit(final FarmLodgingEmissionSource emissionSource, final IsFeature feature)
      throws AeriusException {
    return new Farm2GML().convert(emissionSource);
  }

  @Override
  public nl.overheid.aerius.gml.v3_1.source.EmissionSource visit(final FarmlandEmissionSource emissionSource, final IsFeature feature)
      throws AeriusException {
    return new Farmland2GML().convert(emissionSource);
  }

  @Override
  public nl.overheid.aerius.gml.v3_1.source.EmissionSource visit(final SRM1RoadEmissionSource emissionSource, final IsFeature feature)
      throws AeriusException {
    return new SRM22Road().convert(emissionSource);
  }

  @Override
  public nl.overheid.aerius.gml.v3_1.source.EmissionSource visit(final SRM2RoadEmissionSource emissionSource, final IsFeature feature)
      throws AeriusException {
    return new SRM22Road().convert(emissionSource);
  }
