...
import nl.overheid.aerius.gml.v5_1.source.road.ADMSRoadSideBarrierProperty;
import nl.overheid.aerius.gml.v5_1.source.road.CustomVehicle;
import nl.overheid.aerius.gml.v5_1.source.road.RoadEmissionSource;
import nl.overheid.aerius.gml.v5_1.source.road.RoadSideBarrierProperty;
import nl.overheid.aerius.gml.v5_1.source.road.SRM1Road;
import nl.overheid.aerius.gml.v5_1.source.road.SRM1RoadLinearReference;
import nl.overheid.aerius.gml.v5_1.source.road.SRM1RoadLinearReferenceProperty;
import nl.overheid.aerius.gml.v5_1.source.road.SRM2Road;
import nl.overheid.aerius.gml.v5_1.source.road.SRM2RoadLinearReference;
import nl.overheid.aerius.gml.v5_1.source.road.SRM2RoadLinearReferenceProperty;
import nl.overheid.aerius.gml.v5_1.source.road.SpecificVehicle;
import nl.overheid.aerius.gml.v5_1.source.road.StandardVehicle;
import nl.overheid.aerius.gml.v5_1.source.road.VehiclesProperty;
...
class Road2GML extends SpecificSource2GML<nl.overheid.aerius.shared.domain.v2.source.RoadEmissionSource> {
  ...
  @Override
  public nl.overheid.aerius.gml.v5_1.source.EmissionSource convert(
      final nl.overheid.aerius.shared.domain.v2.source.RoadEmissionSource emissionSource) {
    final nl.overheid.aerius.gml.v5_1.source.EmissionSource returnSource;
  ...
  private RoadSideBarrierProperty toGMLRoadSideBarrier(final SRM2RoadSideBarrier barrier) {
    final nl.overheid.aerius.gml.v5_1.source.road.RoadSideBarrier gmlBarrier = new nl.overheid.aerius.gml.v5_1.source.road.RoadSideBarrier();
  ...
  private ADMSRoadSideBarrierProperty toGMLRoadSideBarrier(final ADMSRoadSideBarrier barrier) {
    final nl.overheid.aerius.gml.v5_1.source.road.ADMSRoadSideBarrier gmlBarrier = new nl.overheid.aerius.gml.v5_1.source.road.ADMSRoadSideBarrier();
    gmlBarrier.setBarrierType(barrier.getBarrierType());
