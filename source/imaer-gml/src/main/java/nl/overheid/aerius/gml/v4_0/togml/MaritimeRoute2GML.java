...
import nl.overheid.aerius.gml.v4_0.source.ship.MaritimeShippingProperty;
...
class MaritimeRoute2GML extends SpecificSource2GML<MaritimeShippingEmissionSource> {
  ...
  @Override
  public nl.overheid.aerius.gml.v4_0.source.EmissionSource convert(final MaritimeShippingEmissionSource emissionSource) {
    final nl.overheid.aerius.gml.v4_0.source.ship.MaritimeShippingEmissionSource returnSource = new nl.overheid.aerius.gml.v4_0.source.ship.MaritimeShippingEmissionSource();
    ...
    for (final MaritimeShipping vesselGroup : vesselGroups) {
      final nl.overheid.aerius.gml.v4_0.source.ship.MaritimeShipping gmlShip = determineType(vesselGroup);
  ...
  private nl.overheid.aerius.gml.v4_0.source.ship.MaritimeShipping determineType(final MaritimeShipping maritimeShipping) {
    nl.overheid.aerius.gml.v4_0.source.ship.MaritimeShipping gmlMaritimeShipping;
  ...
  private nl.overheid.aerius.gml.v4_0.source.ship.MaritimeShipping toStandard(final StandardMaritimeShipping maritimeShipping) {
    final nl.overheid.aerius.gml.v4_0.source.ship.StandardMaritimeShipping gmlShip = new nl.overheid.aerius.gml.v4_0.source.ship.StandardMaritimeShipping();
    gmlShip.setCode(maritimeShipping.getShipCode());
    return gmlShip;
  }

  private nl.overheid.aerius.gml.v4_0.source.ship.MaritimeShipping toCustom(final CustomMaritimeShipping maritimeShipping) {
    final nl.overheid.aerius.gml.v4_0.source.ship.CustomMaritimeShipping gmlShip = new nl.overheid.aerius.gml.v4_0.source.ship.CustomMaritimeShipping();
