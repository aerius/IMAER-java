...
import nl.overheid.aerius.gml.v5_1.source.mobile.CustomOffRoadMobileSource;
import nl.overheid.aerius.gml.v5_1.source.mobile.OffRoadMobileSource;
import nl.overheid.aerius.gml.v5_1.source.mobile.OffRoadMobileSourceProperty;
...
class OffRoad2GML extends SpecificSource2GML<OffRoadMobileEmissionSource> {
  ...
  @Override
  public nl.overheid.aerius.gml.v5_1.source.EmissionSource convert(final OffRoadMobileEmissionSource emissionSource) {
    final nl.overheid.aerius.gml.v5_1.source.mobile.OffRoadMobileEmissionSource returnSource = new nl.overheid.aerius.gml.v5_1.source.mobile.OffRoadMobileEmissionSource();
