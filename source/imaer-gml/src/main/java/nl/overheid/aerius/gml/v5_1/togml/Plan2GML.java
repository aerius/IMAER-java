...
import nl.overheid.aerius.gml.v5_1.source.plan.PlanProperty;
...
class Plan2GML extends SpecificSource2GML<PlanEmissionSource> {
  ...
  @Override
  public nl.overheid.aerius.gml.v5_1.source.EmissionSource convert(final PlanEmissionSource emissionSource) {
    final nl.overheid.aerius.gml.v5_1.source.plan.PlanEmissionSource returnSource = new nl.overheid.aerius.gml.v5_1.source.plan.PlanEmissionSource();
    ...
    for (final Plan plan : planSources) {
      final nl.overheid.aerius.gml.v5_1.source.plan.Plan gmlPlanSource = new nl.overheid.aerius.gml.v5_1.source.plan.Plan();
