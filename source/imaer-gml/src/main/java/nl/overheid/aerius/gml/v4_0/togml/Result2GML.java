...
import nl.overheid.aerius.gml.v4_0.result.CalculationPointCorrection;
import nl.overheid.aerius.gml.v4_0.result.CalculationPointCorrectionProperty;
import nl.overheid.aerius.gml.v4_0.result.CustomCalculationPoint;
import nl.overheid.aerius.gml.v4_0.result.NSLCalculationPoint;
import nl.overheid.aerius.gml.v4_0.result.ReceptorPoint;
import nl.overheid.aerius.gml.v4_0.result.Result;
import nl.overheid.aerius.gml.v4_0.result.ResultProperty;
