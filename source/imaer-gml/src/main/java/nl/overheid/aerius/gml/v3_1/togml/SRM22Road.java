...
import nl.overheid.aerius.gml.v3_1.source.road.AbstractVehicle;
import nl.overheid.aerius.gml.v3_1.source.road.CustomVehicle;
import nl.overheid.aerius.gml.v3_1.source.road.RoadEmissionSource;
import nl.overheid.aerius.gml.v3_1.source.road.RoadSideBarrierProperty;
import nl.overheid.aerius.gml.v3_1.source.road.SRM1Road;
import nl.overheid.aerius.gml.v3_1.source.road.SRM1RoadLinearReference;
import nl.overheid.aerius.gml.v3_1.source.road.SRM1RoadLinearReferenceProperty;
import nl.overheid.aerius.gml.v3_1.source.road.SRM2Road;
import nl.overheid.aerius.gml.v3_1.source.road.SRM2RoadLinearReference;
import nl.overheid.aerius.gml.v3_1.source.road.SRM2RoadLinearReferenceProperty;
import nl.overheid.aerius.gml.v3_1.source.road.SpecificVehicle;
import nl.overheid.aerius.gml.v3_1.source.road.StandardVehicle;
import nl.overheid.aerius.gml.v3_1.source.road.VehiclesProperty;
 ...
 */
class SRM22Road extends SpecificSource2GML<nl.overheid.aerius.shared.domain.v2.source.RoadEmissionSource> {
  ...
  public nl.overheid.aerius.gml.v3_1.source.EmissionSource convert(
    ...
    final nl.overheid.aerius.gml.v3_1.source.EmissionSource returnSource;
  ...
  private RoadSideBarrierProperty toGMLRoadSideBarrier(final RoadSideBarrier barrier) {
    final nl.overheid.aerius.gml.v3_1.source.road.RoadSideBarrier gmlBarrier = new nl.overheid.aerius.gml.v3_1.source.road.RoadSideBarrier();
