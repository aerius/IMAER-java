...
import nl.overheid.aerius.gml.v5_1.source.farmland.FarmlandActivity;
...
class Farmland2GML extends SpecificSource2GML<FarmlandEmissionSource> {
  ...
  public nl.overheid.aerius.gml.v5_1.source.EmissionSource convert(final FarmlandEmissionSource emissionSource) {
    final nl.overheid.aerius.gml.v5_1.source.farmland.FarmlandEmissionSource returnSource = new nl.overheid.aerius.gml.v5_1.source.farmland.FarmlandEmissionSource();
