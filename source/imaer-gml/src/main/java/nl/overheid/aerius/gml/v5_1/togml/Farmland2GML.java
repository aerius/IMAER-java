...
import nl.overheid.aerius.gml.v5_1.source.farmland.FarmlandActivityProperty;
...
class Farmland2GML extends SpecificSource2GML<FarmlandEmissionSource> {
  ...
  @Override
  public nl.overheid.aerius.gml.v5_1.source.EmissionSource convert(final FarmlandEmissionSource emissionSource) {
    final nl.overheid.aerius.gml.v5_1.source.farmland.FarmlandEmissionSource returnSource =
        new nl.overheid.aerius.gml.v5_1.source.farmland.FarmlandEmissionSource();
  ...
  private nl.overheid.aerius.gml.v5_1.source.farmland.CustomFarmlandActivity convert(final CustomFarmlandActivity landSource) {
    final nl.overheid.aerius.gml.v5_1.source.farmland.CustomFarmlandActivity gmlLandSource =
        new nl.overheid.aerius.gml.v5_1.source.farmland.CustomFarmlandActivity();
  ...
  private nl.overheid.aerius.gml.v5_1.source.farmland.StandardFarmlandActivity convert(final StandardFarmlandActivity landSource) {
