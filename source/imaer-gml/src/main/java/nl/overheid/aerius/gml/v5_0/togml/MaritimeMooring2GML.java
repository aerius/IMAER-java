...
import nl.overheid.aerius.gml.v5_0.source.ship.MooringMaritimeShippingProperty;
...
class MaritimeMooring2GML extends SpecificSource2GML<MooringMaritimeShippingEmissionSource> {
  ...
  @Override
  public nl.overheid.aerius.gml.v5_0.source.EmissionSource convert(final MooringMaritimeShippingEmissionSource emissionSource)
      throws AeriusException {
    final nl.overheid.aerius.gml.v5_0.source.ship.MooringMaritimeShippingEmissionSource returnSource = new nl.overheid.aerius.gml.v5_0.source.ship.MooringMaritimeShippingEmissionSource();
    ...
    for (final MooringMaritimeShipping vesselGroup : vesselGroups) {
      final nl.overheid.aerius.gml.v5_0.source.ship.MooringMaritimeShipping gmlShip = determineType(vesselGroup);
  ...
  private nl.overheid.aerius.gml.v5_0.source.ship.MooringMaritimeShipping determineType(final MooringMaritimeShipping maritimeShipping) {
    nl.overheid.aerius.gml.v5_0.source.ship.MooringMaritimeShipping gmlMaritimeShipping;
  ...
  private nl.overheid.aerius.gml.v5_0.source.ship.MooringMaritimeShipping toStandard(final StandardMooringMaritimeShipping vesselGroup) {
    final nl.overheid.aerius.gml.v5_0.source.ship.StandardMooringMaritimeShipping gmlShip = new nl.overheid.aerius.gml.v5_0.source.ship.StandardMooringMaritimeShipping();
    gmlShip.setCode(vesselGroup.getShipCode());
    return gmlShip;
  }

  private nl.overheid.aerius.gml.v5_0.source.ship.MooringMaritimeShipping toCustom(final CustomMooringMaritimeShipping maritimeShipping) {
    final nl.overheid.aerius.gml.v5_0.source.ship.CustomMooringMaritimeShipping gmlShip = new nl.overheid.aerius.gml.v5_0.source.ship.CustomMooringMaritimeShipping();
