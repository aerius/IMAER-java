...
import nl.overheid.aerius.gml.v4_0.source.farmland.FarmlandActivity;
import nl.overheid.aerius.gml.v4_0.source.farmland.FarmlandActivityProperty;
...
class Farmland2GML extends SpecificSource2GML<FarmlandEmissionSource> {
  ...
  @Override
  public nl.overheid.aerius.gml.v4_0.source.EmissionSource convert(final FarmlandEmissionSource emissionSource) {
    final nl.overheid.aerius.gml.v4_0.source.farmland.FarmlandEmissionSource returnSource = new nl.overheid.aerius.gml.v4_0.source.farmland.FarmlandEmissionSource();
