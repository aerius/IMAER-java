...
import nl.overheid.aerius.gml.v5_0.source.ship.MooringInlandShippingProperty;
...
class InlandMooring2GML extends SpecificSource2GML<MooringInlandShippingEmissionSource> {
  ...
  @Override
  public nl.overheid.aerius.gml.v5_0.source.EmissionSource convert(final MooringInlandShippingEmissionSource emissionSource)
      throws AeriusException {
    final nl.overheid.aerius.gml.v5_0.source.ship.MooringInlandShippingEmissionSource returnSource = new nl.overheid.aerius.gml.v5_0.source.ship.MooringInlandShippingEmissionSource();
    ...
    for (final MooringInlandShipping vesselGroup : vesselGroups) {
      final nl.overheid.aerius.gml.v5_0.source.ship.MooringInlandShipping gmlShip = determineType(vesselGroup);
  ...
  private nl.overheid.aerius.gml.v5_0.source.ship.MooringInlandShipping determineType(final MooringInlandShipping inlandShipping) {
    nl.overheid.aerius.gml.v5_0.source.ship.MooringInlandShipping gmlInlandShipping;
  ...
  private nl.overheid.aerius.gml.v5_0.source.ship.MooringInlandShipping toStandard(final StandardMooringInlandShipping vesselGroup) {
    final nl.overheid.aerius.gml.v5_0.source.ship.StandardMooringInlandShipping gmlShip = new nl.overheid.aerius.gml.v5_0.source.ship.StandardMooringInlandShipping();
    gmlShip.setCode(vesselGroup.getShipCode());
    return gmlShip;
  }

  private nl.overheid.aerius.gml.v5_0.source.ship.MooringInlandShipping toCustom(final CustomMooringInlandShipping vesselGroup) {
    final nl.overheid.aerius.gml.v5_0.source.ship.CustomMooringInlandShipping gmlShip = new nl.overheid.aerius.gml.v5_0.source.ship.CustomMooringInlandShipping();
