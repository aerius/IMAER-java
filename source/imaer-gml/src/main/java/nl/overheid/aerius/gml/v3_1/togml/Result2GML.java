...
import nl.overheid.aerius.gml.v3_1.result.CalculationPointCorrection;
import nl.overheid.aerius.gml.v3_1.result.CalculationPointCorrectionProperty;
import nl.overheid.aerius.gml.v3_1.result.CustomCalculationPoint;
import nl.overheid.aerius.gml.v3_1.result.NSLCalculationPoint;
import nl.overheid.aerius.gml.v3_1.result.ReceptorPoint;
import nl.overheid.aerius.gml.v3_1.result.Result;
import nl.overheid.aerius.gml.v3_1.result.ResultProperty;
