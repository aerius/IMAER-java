        ...
        <imaer:EmissionSource sectorId="2100" gml:id="ES.1">
            ...
            <imaer:geometry>
                <imaer:EmissionSourceGeometry>
                    <imaer:GM_SURFACE> !-- testing for illegal character -->
                        <gml:Surface gml:id="ES.1.SURFACE" srsName="urn:ogc:def:crs:ESPG::28992">
                            <gml:pos>116105.98 481758.48 116505.98 482158.48</gml:pos>
                        </gml:Surface>
                    </imaer:GM_SURFACE>
                </imaer:EmissionSourceGeometry>
            </imaer:geometry>
