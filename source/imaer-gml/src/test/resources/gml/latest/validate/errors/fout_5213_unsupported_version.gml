...
<imaer:FeatureCollectionCalculator xmlns:imaer="http://imaer.aerius.nl/0.4" xmlns:gml="http://www.opengis.net/gml/3.2" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" gml:id="NL.IMAER.Collection" xsi:schemaLocation="http://imaer.aerius.nl/0.4 http://imaer.aerius.nl/0.4/IMAER.xsd">
        ...
        <imaer:EmissionSource sectorId="2100" gml:id="ES.1">
            ...
            <imaer:geometry>
                <imaer:EmissionSourceGeometry>
                    <imaer:GM_Point>
                        <gml:Point gml:id="ES.1.POINT" srsName="urn:ogc:def:crs:EPSG::27354">
