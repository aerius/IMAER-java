        ...
        <imaer:SRM2Road sectorId="3111" gml:id="ES.2">
            ...
            <imaer:geometry>
                <imaer:EmissionSourceGeometry>
                    <imaer:GM_Curve>
                        <gml:LineString gml:id="ES.2.CURVE" srsName="urn:ogc:def:crs:EPSG::28992">
            ...
            <imaer:emission>
                <imaer:Emission substance="NH3">
                    <imaer:value>787.0290525631773</imaer:value>
                </imaer:Emission>
            </imaer:emission>
            <imaer:emission>
                <imaer:Emission substance="NOX">
                    <imaer:value>32230.65522879202</imaer:value>
                </imaer:Emission>
            </imaer:emission>
            <imaer:emission>
                <imaer:Emission substance="PM10">
                    <imaer:value>1448.6371527338454</imaer:value>
                </imaer:Emission>
            </imaer:emission>
            <imaer:emission>
                <imaer:Emission substance="NO2">
                    <imaer:value>4827.885135833983</imaer:value>
                </imaer:Emission>
            </imaer:emission>
            <imaer:vehicles>
