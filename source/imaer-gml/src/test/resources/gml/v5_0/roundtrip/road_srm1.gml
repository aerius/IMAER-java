...
<imaer:FeatureCollectionCalculator xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:gml="http://www.opengis.net/gml/3.2" xmlns:imaer="http://imaer.aerius.nl/5.0" gml:id="NL.IMAER.Collection" xsi:schemaLocation="http://imaer.aerius.nl/5.0 https://imaer.aerius.nl/5.0/IMAER.xsd">
        ...
        <imaer:AeriusCalculatorMetadata>
            ...
            <imaer:situation>
                <imaer:SituationMetadata>
                    <imaer:name>Situatie 1</imaer:name>
                    <imaer:reference>RzjbVuSNcncK</imaer:reference>
    ...
    <imaer:featureMember>
        <imaer:SRM1Road sectorId="3100" gml:id="ES.1" roadAreaType="NL" roadType="URBAN_ROAD_NORMAL">
            <imaer:identifier>
                <imaer:NEN3610ID>
            ...
            <imaer:emission>
                <imaer:Emission substance="NH3">
                    <imaer:value>15.731802921677476</imaer:value>
                </imaer:Emission>
            </imaer:emission>
            <imaer:emission>
                <imaer:Emission substance="NOX">
                    <imaer:value>149.4812607243095</imaer:value>
                </imaer:Emission>
            </imaer:emission>
            <imaer:emission>
            ...
            <imaer:emission>
                <imaer:Emission substance="NO2">
                    <imaer:value>27.705452923176445</imaer:value>
                </imaer:Emission>
            </imaer:emission>
            <imaer:vehicles>
