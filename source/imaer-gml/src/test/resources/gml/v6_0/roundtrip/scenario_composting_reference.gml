        ...
        <imaer:AeriusCalculatorMetadata>
            ...
            <imaer:situation>
                <imaer:SituationMetadata>
                    <imaer:name> Nbw-vergund met NH3</imaer:name>
                    <imaer:reference>RQiEPVosHWoc</imaer:reference>
...
<gml:LinearRing>
    ...
    <imaer:featureMember>
        <imaer:EmissionSource sectorId="1050" gml:id="ES.3">
            ...
            <imaer:label>aggregaat sorteerinstallatie</imaer:label>
            <imaer:emissionSourceCharacteristics>
                <imaer:EmissionSourceCharacteristics>
                    <imaer:heatContent>
                ...
                <imaer:EmissionSourceGeometry>
                    <imaer:GM_Point>
                        <gml:Point srsName="urn:ogc:def:crs:EPSG::28992" gml:id="ES.3.POINT">
                            <gml:pos>170404.0 372054.0</gml:pos>
                        </gml:Point>
                    </imaer:GM_Point>
                </imaer:EmissionSourceGeometry>
            </imaer:geometry>
            ...
            <imaer:emission>
                <imaer:Emission substance="NOX">
                    <imaer:value>3283.2</imaer:value>
                </imaer:Emission>
            </imaer:emission>
            <imaer:emission>
                <imaer:Emission substance="PM10">
    ...
    <imaer:featureMember>
        <imaer:EmissionSource sectorId="1050" gml:id="ES.6">
            ...
            <imaer:label>pomp beregening</imaer:label>
            <imaer:emissionSourceCharacteristics>
                <imaer:EmissionSourceCharacteristics>
                    <imaer:heatContent>
                        <imaer:CalculatedHeatContent>
                ...
                <imaer:EmissionSourceGeometry>
                    <imaer:GM_Point>
                        <gml:Point srsName="urn:ogc:def:crs:EPSG::28992" gml:id="ES.6.POINT">
                            <gml:pos>170512.0 372099.0</gml:pos>
                        </gml:Point>
                    </imaer:GM_Point>
                </imaer:EmissionSourceGeometry>
            </imaer:geometry>
            ...
            <imaer:emission>
                <imaer:Emission substance="NOX">
                    <imaer:value>1354.3</imaer:value>
                </imaer:Emission>
            </imaer:emission>
            <imaer:emission>
                <imaer:Emission substance="PM10">
    ...
    <imaer:featureMember>
        <imaer:EmissionSource sectorId="1050" gml:id="ES.7">
            ...
            <imaer:label>WKK (4 motoren)</imaer:label>
            <imaer:emissionSourceCharacteristics>
                <imaer:EmissionSourceCharacteristics>
                    <imaer:heatContent>
                        <imaer:CalculatedHeatContent>
                            <imaer:emissionTemperature>300.0</imaer:emissionTemperature>
                            <imaer:outflowDiameter>1.4</imaer:outflowDiameter>
                            <imaer:outflowVelocity>11.0</imaer:outflowVelocity>
                            <imaer:outflowDirection>VERTICAL</imaer:outflowDirection>
                            <imaer:outflowVelocityType>ACTUAL_FLOW</imaer:outflowVelocityType>
                        </imaer:CalculatedHeatContent>
                    </imaer:heatContent>
                    <imaer:emissionHeight>2.7</imaer:emissionHeight>
                    <imaer:spread>1.35</imaer:spread>
                    <imaer:timeVaryingProfile>
                        <imaer:StandardTimeVaryingProfile>
                            <imaer:standardType>INDUSTRIAL_ACTIVITY</imaer:standardType>
                        </imaer:StandardTimeVaryingProfile>
    ...
    <imaer:featureMember>
        <imaer:EmissionSource sectorId="1050" gml:id="ES.27">
            <imaer:identifier>
                <imaer:NEN3610ID>
                    <imaer:namespace>NL.IMAER</imaer:namespace>
            ...
            <imaer:label>aggregaat beluchting compostering</imaer:label>
            <imaer:emissionSourceCharacteristics>
                <imaer:EmissionSourceCharacteristics>
                    <imaer:heatContent>
                        <imaer:CalculatedHeatContent>
                ...
                <imaer:EmissionSourceGeometry>
                    <imaer:GM_Point>
                        <gml:Point srsName="urn:ogc:def:crs:EPSG::28992" gml:id="ES.27.POINT">
                            <gml:pos>170218.78 372135.96</gml:pos>
                        </gml:Point>
                    </imaer:GM_Point>
                </imaer:EmissionSourceGeometry>
            </imaer:geometry>
            ...
            <imaer:emission>
                <imaer:Emission substance="NOX">
                    <imaer:value>4493.9</imaer:value>
                </imaer:Emission>
            </imaer:emission>
            <imaer:emission>
                <imaer:Emission substance="PM10">
    ...
    <imaer:featureMember>
        <imaer:EmissionSource sectorId="1050" gml:id="ES.28">
            <imaer:identifier>
                <imaer:NEN3610ID>
                    <imaer:namespace>NL.IMAER</imaer:namespace>
            ...
            <imaer:label>aggregaat waterzuivering</imaer:label>
            <imaer:emissionSourceCharacteristics>
                <imaer:EmissionSourceCharacteristics>
                    <imaer:heatContent>
                        <imaer:CalculatedHeatContent>
                ...
                <imaer:EmissionSourceGeometry>
                    <imaer:GM_Point>
                        <gml:Point srsName="urn:ogc:def:crs:EPSG::28992" gml:id="ES.28.POINT">
                            <gml:pos>170223.82 372140.16</gml:pos>
                        </gml:Point>
                    </imaer:GM_Point>
                </imaer:EmissionSourceGeometry>
            </imaer:geometry>
            ...
            <imaer:emission>
                <imaer:Emission substance="NOX">
                    <imaer:value>11983.7</imaer:value>
                </imaer:Emission>
            </imaer:emission>
            <imaer:emission>
                <imaer:Emission substance="PM10">
    ...
    <imaer:featureMember>
        <imaer:EmissionSource sectorId="1050" gml:id="ES.29">
            <imaer:identifier>
                <imaer:NEN3610ID>
                    <imaer:namespace>NL.IMAER</imaer:namespace>
            ...
            <imaer:label>biofilter ontvangsthal</imaer:label>
            <imaer:emissionSourceCharacteristics>
                <imaer:EmissionSourceCharacteristics>
                    <imaer:heatContent>
                        <imaer:CalculatedHeatContent>
                            <imaer:emissionTemperature>12.85</imaer:emissionTemperature>
                            <imaer:outflowDiameter>1.6</imaer:outflowDiameter>
                ...
                <imaer:EmissionSourceGeometry>
                    <imaer:GM_Point>
                        <gml:Point srsName="urn:ogc:def:crs:EPSG::28992" gml:id="ES.29.POINT">
                            <gml:pos>170512.0 372278.0</gml:pos>
                        </gml:Point>
                    </imaer:GM_Point>
                </imaer:EmissionSourceGeometry>
            </imaer:geometry>
            <imaer:emission>
                <imaer:Emission substance="NH3">
                    <imaer:value>1314.0</imaer:value>
                </imaer:Emission>
            </imaer:emission>
            <imaer:emission>
                <imaer:Emission substance="NOX">
    ...
    <imaer:featureMember>
        <imaer:EmissionSource sectorId="4120" gml:id="ES.30">
            <imaer:identifier>
                <imaer:NEN3610ID>
                    <imaer:namespace>NL.IMAER</imaer:namespace>
            ...
            <imaer:label>mestzakken</imaer:label>
            <imaer:emissionSourceCharacteristics>
                <imaer:EmissionSourceCharacteristics>
                    <imaer:heatContent>
                        <imaer:SpecifiedHeatContent>
                ...
                <imaer:EmissionSourceGeometry>
                    <imaer:GM_Surface>
                        <gml:Polygon srsName="urn:ogc:def:crs:EPSG::28992" gml:id="ES.30.SURFACE">
                            <gml:exterior>
<gml:LinearRing>
    <gml:posList>170502.91 372385.44 170480.23 372338.4 170588.59 372282.12 170608.75 372326.64 170502.91 372385.44</gml:posList>
</gml:LinearRing>
                            </gml:exterior>
                        </gml:Polygon>
                    </imaer:GM_Surface>
...
<gml:LinearRing>
    <gml:posList>170235.45651172037 371975.9610558798 170470.65651172012 371900.3610558799 170586.57651172034 372271.64105587977 170475.69651172007 372336.32105587964 170443.77651171965 372244.7610558802 170287.53651172 372297.2610558802 170198.4965117201 372050.72105588025 170235.45651172037 371975.9610558798</gml:posList>
            ...
            <imaer:emission>
                <imaer:Emission substance="NOX">
                    <imaer:value>33641.0</imaer:value>
                </imaer:Emission>
            </imaer:emission>
            <imaer:emission>
                <imaer:Emission substance="PM10">
