        ...
        <imaer:AeriusCalculatorMetadata>
            ...
            <imaer:situation>
                <imaer:SituationMetadata>
                    <imaer:name>Situatie 1</imaer:name>
                    <imaer:reference>NotImportant</imaer:reference>
    ...
    <gml:posList>69422.14 443595.6 69516.22 443575.44 69522.94 443696.4 69435.58 443689.68 69422.14 443595.6</gml:posList>
            ...
            <imaer:emission>
                <imaer:Emission substance="NH3">
                    <imaer:value>0.1344</imaer:value>
                </imaer:Emission>
            </imaer:emission>
            <imaer:emission>
                <imaer:Emission substance="NOX">
                    <imaer:value>2.952</imaer:value>
                </imaer:Emission>
            </imaer:emission>
            <imaer:emission>
            ...
            <imaer:offRoadMobileSource>
                <imaer:StandardOffRoadMobileSource offRoadMobileSourceType="POWER_BASED">
                    <imaer:description>Krachtige apparaten</imaer:description>
                    <imaer:operatingHoursPerYear>200</imaer:operatingHoursPerYear>
