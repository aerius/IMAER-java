...
public abstract class Vehicles implements Serializable {
  ...
  @JsonIgnore
  public double getVehiclesPer(final TimeUnit targetTimeUnit) {
    return this.timeUnit == targetTimeUnit ? vehiclesPerTimeUnit : this.timeUnit.toUnit(vehiclesPerTimeUnit, targetTimeUnit);
  }
