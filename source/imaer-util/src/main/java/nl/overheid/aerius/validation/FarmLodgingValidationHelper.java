...
public interface FarmLodgingValidationHelper {
  ...
  boolean isValidFarmLodgingAdditionalSystemCode(String systemCode);

  boolean isValidFarmLodgingReductiveSystemCode(String systemCode);

  boolean isValidFarmLodgingFodderMeasureCode(String fodderMeasureCode);
